 ...
 */
public class Toggle extends BotCommand {
    ...
    public void run(ChatMessage message, String[] args) throws Exception {
        ...
        if (Resource.canPrint()) {

            Resource.message("Sending messages has been turned off");
            Resource.setCanPrint(false);
        } else {

            Resource.setCanPrint(true);
            Resource.message("Sending messages has been enabled");
        }
    }
}
